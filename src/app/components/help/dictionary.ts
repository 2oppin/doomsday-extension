...
export const HelpDict: {[key in HelpInfo]: HelpTooltip} = {
    ...
    [HelpInfo.TaskItemMarkDone]: {text: "Click to mark task finished (available only if you are currently working on this task)"},
    [HelpInfo.TaskItemDiscard]: {text: "Click to discard task (available only if you are currently working on this task)"},
    ...
    [HelpInfo.TaskItemReopen]: {text: "Click to ReOpen task"},
